        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Brand_BrandId",
                        column: x => x.BrandId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Restaurant_Brand_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Brand",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserRestaurant", x => new { x.AppUsersId, x.RestaurantsId });
                    table.ForeignKey(
                        name: "FK_AppUserRestaurant_AspNetUsers_AppUsersId",
                        column: x => x.AppUsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_AppUserRestaurant_Restaurant_RestaurantsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageFileName = table.Column<string>(type: "nvarchar(180)", maxLength: 180, nullable: false),
                    StateId = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserRestaurant_RestaurantsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Restaurant_BrandId",
                table: "Restaurant",
                column: "BrandId");

            migrationBuilder.CreateIndex(
                name: "IX_Restaurant_StateId",
                table: "Restaurant",
                column: "StateId");
        }
